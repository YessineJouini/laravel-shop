...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <img src="{{ asset('vendor/adminlte/dist/img/AdminLTELogo.png') }}"  alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">HyperByte</span>
    </a>
  ...
  <a href="{{ route('orders.index') }}"
    ...
    <p>Order Management</p>
          ...
          <li class="nav-item {{ request()->routeIs('categories.*') || request()->routeIs('products.*') ? 'menu-open' : '' }}">
            <a href="#" class="nav-link {{ request()->routeIs('categories.*') || request()->routeIs('products.*') ? 'active' : '' }}">
...
@endif  
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2014-2021 <a href="https://adminlte.io">HyperByte</a>.</strong>
    All rights reserved.
...
<!-- ChartJS -->
<script src="{{asset('vendor/plugins/chart.js/Chart.js')}}"></script>
<!-- Sparkline -->
